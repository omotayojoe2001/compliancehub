-- Create tax_rates table for admin management (Simplified version)
...
-- Create policy for authenticated users to manage tax rates (temporary - for testing)
CREATE POLICY "Authenticated users can manage tax rates" ON tax_rates
