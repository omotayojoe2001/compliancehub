...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml4cWpxanFqcWpxanFqcWoiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTczMzc2NzI5NCwiZXhwIjoyMDQ5MzQzMjk0fQ.123456789';
...
async function createContentTable() {
  try {
    ...
    if (insertError) {
      ...
      console.log('Content table created and populated successfully!');
    }
